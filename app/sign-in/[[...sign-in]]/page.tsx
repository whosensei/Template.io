    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <div 
          ...
          style={{
            backgroundImage: "url('/White Clouds Photo.jpg')"
          }}
        />
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white lg:w-1/2">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Enter your credentials to access your templates</p>
          </div>
          ...
          {/* Email/Password Form */}
          <form onSubmit={handleCredentialsSignIn} className="space-y-6 mb-8">
            {/* Email Input */}
            <div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-500 leading-relaxed mb-4">
              By signing in, you acknowledge that you have both read and agree to Template.io's{" "}
